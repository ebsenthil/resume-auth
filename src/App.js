...
import "./App.css";
// Import the Authenticator component and its styles
import { Authenticator } from '@aws-amplify/ui-react';
import '@aws-amplify/ui-react/styles.css'; // Default styles for the Authenticator UI
...
function App() {
    ...
    const handleGenerateResume = async () => {
        ...
        try {
            // --- Potential place to add authorization header later ---
            ...
            const response = await fetch("https://2no2a0hmtd.execute-api.us-east-1.amazonaws.com/dev/resume-view2", {
                ...
                headers: {
                    ...
                    // "Authorization": `Bearer ${token}` // <-- Add this if your backend is secured
                },
    ...
    // Helper function to render text areas (already in your code)
    const renderTextArea = (fieldName, rows = 3) => {
        let value = editedData?.[fieldName]; // Use optional chaining for safety
    ...
    // Helper function to render experience editor (already in your code)
    ...
    // --- Wrap your main application content with Authenticator ---
    return (
        // Authenticator uses a render prop pattern
        <Authenticator>
           {({ signOut, user }) => ( // This function receives signOut and user props
               <div className="App container"> {/* Your existing app content */}
                   {/* Optional: Display logged-in user and Sign Out button */}
                   <div style={{ textAlign: 'right', marginBottom: '20px' }}>
                       Hello, {user.username}!
                       <button onClick={signOut} style={{ marginLeft: '10px' }}>Sign Out</button>
                   </div>
                   {/* End of optional user info/sign out */}
                       ...
                       <div className="resume-card">
                           <div className="resume-header">
                               ...
                               <input
                                   type="text"
                                   id="preview-role"
                                   name="currentRole" // Assuming your API returns 'currentRole' or you want to add it
                           ...
                           <section>
                               ...
                               {renderTextArea("summary", 4)} {/* Assuming your API returns 'summary' */}
                           </section>
